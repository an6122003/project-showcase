...
export const Modal = ({ isOpen, onClose, title, children }: { isOpen: boolean, onClose: () => void, title?: string, children: React.ReactNode }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
      ...
      <div className="bg-white border-4 border-black w-full max-w-6xl max-h-[92vh] flex flex-col shadow-[8px_8px_0_0_#000] relative overflow-hidden rounded-xl animate-in fade-in zoom-in-95 duration-200">
